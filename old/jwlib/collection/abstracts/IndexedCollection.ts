...
import {IIndexedCollection} from '../interfaces/IIndexedCollection';
 ...
 */
export abstract class IndexedCollection<K, T> extends AbstractCollection<T> implements IIndexedCollection<K, T> {
	/**
	 * @inheritdoc
	 */
