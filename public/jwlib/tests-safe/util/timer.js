...
JW.Tests.Util.TimerTestCase = JW.Unit.TestCase.extend({
	testTimer: function()
	{
		...
		var onTimer1 = this.async("onTimer1", this._onTimer1, 1500, 1);
		var onTimer2 = this.async("onTimer2", this._onTimer2, 1500, 3);
		
		this.timer1.bind("tick", onTimer1, this);
		this.timer2.bind("tick", onTimer2, this);
