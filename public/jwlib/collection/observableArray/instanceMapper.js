...
JW.ObservableArray.InstanceMapper = function(config) {
	JW.ObservableArray.InstanceMapper._super.call(this);
...
JW.extend(JW.ObservableArray.InstanceMapper/*<S extends JW.Class, T extends JW.Class>*/, JW.Class, {
	/*
	Required
