...
JW.Tests.Util.SyncherTestCase = JW.Unit.TestCase.extend({
	...
	testSyncher: function()
	{
		...
		model.base.removeItem("a");
		model.base.removeItem("g");
		model.triggerFilter();
	...
	testArraySyncher: function()
	{
		...
		this.assertTrue(source.base.equal(target));
		...
		source.moveItem(3, 1);
		this.assertTrue(JW.equal([ { id : "a" }, { id : "c" }, { id : "f" }, { id : "a" }, { id : "d" } ], target, true, true));
		this.assertTrue(source.base.equal(target));
		
		source.base.sortBy("id");
		source.triggerReorder();
		this.assertTrue(JW.equal([ { id : "a" }, { id : "a" }, { id : "c" }, { id : "d" }, { id : "f" } ], target, true, true));
		this.assertTrue(source.base.equal(target));
		
		source.base.removeItemAt(2);
		source.triggerFilter();
		this.assertTrue(JW.equal([ { id : "a" }, { id : "a" }, { id : "d" }, { id : "f" } ], target, true, true));
		this.assertTrue(source.base.equal(target));
