...
JW.Tests.Collection.AbstractArray.OrdererTestCase = JW.Unit.TestCase.extend({
	setup: function() {
	...
	testShorthand: function() {
		var source = new JW.Array([this.a, this.b]);
	...
	testMultiSource: function() {
		var source1 = new JW.Array([this.a, this.b]);
		var source2 = new JW.Array([this.c, this.d]);
		var target = this.createTarget();
	...
	testAutoTarget: function() {
		var source = new JW.Array([this.d]);
