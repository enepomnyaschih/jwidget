...
JW.Tests.Core.ObservableTestCase = JW.Unit.TestCase.extend({
	...
	testFlagEvents: function()
	{
		...
		dispatcher.bind("myevent", onMyEvent.withArgs("\0", "a"), this, true);
		dispatcher.bind("myevent", onMyEvent.withArgs("\0", "b"), this);
		...
		dispatcher.bind("myevent", onMyEvent.withArgs("\0", "c"), this, true);
		
		this.setExpectedOutput(
			"Handle: d"
		);
		dispatcher.bind("myevent", onMyEvent.withArgs("\0", "d"), this);
