...
module JW {
	 ...
	 */
	export class Property<V> extends Class {
		 ...
		 */
		changeEvent = this.own(new Event<Property.ChangeEventParams<V>>());
		...
		protected destroyObject() {
			...
			if (this._ownsValue && (this._value != null)) {
				(<Destroyable>(<any>this._value)).destroy();
			}
			super.destroyObject();
		}
