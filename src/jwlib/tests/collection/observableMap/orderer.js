...
JW.Tests.Collection.ObservableMap.OrdererTestCase = JW.Unit.TestCase.extend({
	setup: function() {
	...
	testShorthand: function() {
		var source = new JW.ObservableMap({"A": this.a, "B": this.b, "C": this.c, "D": this.d});
		...
		source.splice(["B", "D"], {"E": this.e, "F": this.f}); // e,f,c,a
	...
	testObservableTarget: function() {
		...
		this.setExpectedOutput();
		source.reindex({"E": "Q", "F": "P"}); // e,f,b,a
		this.assertTarget([this.a, this.c, this.e, this.f], target);
		
		this.setExpectedOutput(
			"Changed length from 4 to 0",
			"Spliced -[0:[a,c,e,f]] +[] to [a,c,e,f]",
			"Changed"
		);
		source.clear();
	...
	testMultiSource: function() {
		var source1 = new JW.ObservableMap({"A": this.a, "B": this.b});
		var source2 = new JW.ObservableMap({"C": this.c, "D": this.d});
		var target = this.createTarget();
		...
		source1.splice(["A"], {"E": this.e, "F": this.f}); // b,e,f
	...
	testAutoTarget: function() {
		var source = new JW.ObservableMap({"D": this.d});
