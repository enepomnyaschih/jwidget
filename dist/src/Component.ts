...
export default class Component extends Class {
	 ...
	 */
	addReplaceable(component: Property<Component>, id: string): IClass {
	 ...
	 */
	addArray(source: IArray<Component>): IClass;
	 ...
	 * @returns Child component array wrapper. Destroy it to remove the array from the component.
	 */
	addArray(source: IArray<Component>, el: string): IClass;
	 ...
	 * @returns Child component array wrapper. Destroy it to remove the array from the component.
	 */
	addArray(source: IArray<Component>, el: HTMLElement): IClass;
	 ...
	 * @returns Child component array wrapper. Destroy it to remove the array from the component.
	 */
	addArray(source: IArray<Component>, el: JQuery): IClass;
	addArray(source: IArray<Component>, el?: any): IClass {
	 ...
	 */
	addCollection(source: ICollection<Component>): IClass;
	 ...
	 * @returns Child component collection wrapper. Destroy it to remove the collection from the component.
	 */
	addCollection(source: ICollection<Component>, el: string): IClass;
	 ...
	 * @returns Child component collection wrapper. Destroy it to remove the collection from the component.
	 */
	addCollection(source: ICollection<Component>, el: HTMLElement): IClass;
	 ...
	 * @returns Child component collection wrapper. Destroy it to remove the collection from the component.
	 */
	addCollection(source: ICollection<Component>, el: JQuery): IClass;
	addCollection(source: ICollection<Component>, el?: any): IClass {
