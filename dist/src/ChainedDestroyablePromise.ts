...
export default class ChainedDestroyablePromise<T> implements DestroyablePromise<T> {
	constructor(private _native: Promise<T>, private baseDestroyable: Destroyable) {
	}
