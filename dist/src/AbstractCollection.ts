...
abstract class AbstractCollection<T> extends Class implements ICollection<T> {
	 ...
	 */
	abstract createMapper<U>(config: ICollectionMapperConfig<T, U>): ICollectionMapper<T, U>;
	 ...
	 * @param config Configuration.
	 */
	abstract createFilterer(config: ICollectionFiltererConfig<T>): ICollectionFilterer<T>;
	 ...
	 * @param config Configuration.
	 */
	abstract createCounter(config: ICollectionCounterConfig<T>): ICollectionCounter<T>;
	 ...
	 * @param config Configuration.
	 */
	abstract createObserver(config?: ICollectionObserverConfig<T>): ICollectionObserver;
	 ...
	 * @param config Configuration.
	 */
	abstract createOrderer(config?: ICollectionOrdererConfig<any>): ICollectionOrderer<any>;
	 ...
	 * @param config Configuration.
	 */
	abstract createSorterComparing(config?: ICollectionSorterComparingConfig<T>): ICollectionSorterComparing<T>;
	 ...
	 * @param config Configuration.
	 */
	abstract createIndexer(config: ICollectionIndexerConfig<T>): ICollectionIndexer<T>;
	 ...
	 * @param config Configuration.
	 */
	abstract createLister(config?: ICollectionListerConfig<any>): ICollectionLister<any>;
}
